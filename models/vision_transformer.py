...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x, drop_patch_rate=None):
        ...
        if drop_patch_rate is not None:
            B, N, C = x.shape
    ...
    def forward(self, x, drop_patch_rate=None):
        x = self.forward_features(x, drop_patch_rate=drop_patch_rate)
